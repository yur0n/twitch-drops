...
class TwitchLogin(object):
    ...
    def __init__(self, client_id, device_id, username, init_token, user_agent, password=None):
    ...
    def login_flow(self):
        # '5n92x5cketi68ntcy4iyw2sd3sz4nr'
        # ------------------fix if token is not accepted---------------------------------------------------------------------------------------------------------------------
        if self.init_token is not None:
            self.set_token(self.init_token)
